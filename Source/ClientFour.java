...
public class ClientFour extends JFrame implements ActionListener, Runnable{
	...
	ClientFour() {
		...
		// Profile picture
		ImageIcon ico3 = new ImageIcon("assets/kazuto.png");
		...
		// Profile name
		JLabel lable4 = new JLabel("Kazuto");
	...
	@Override
	public void actionPerformed(ActionEvent ae){
		String output = "Kirito : "+textfild.getText();
		try{
			bw.write(output);
			bw.write("\r\n");
			bw.flush();
	...
	public static void main(String args[]){
		ClientFour client = new ClientFour();
