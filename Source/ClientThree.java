...
public class ClientThree extends JFrame implements ActionListener, Runnable{
	...
	ClientThree() {
		...
		// Profile picture
		ImageIcon ico3 = new ImageIcon("assets/Natsu_Dragneel.png");
		...
		// Profile name
		JLabel lable4 = new JLabel("Natsu");
	...
	@Override
	public void actionPerformed(ActionEvent ae){
		String output = "Natsu : "+textfild.getText();
		try{
			bw.write(output);
			bw.write("\r\n");
			bw.flush();
	...
	public static void main(String args[]){
		ClientThree client = new ClientThree();
